...
const Perks = ({ perks }) => {
  const checkedKillers = useSelector(state => state.character.characters) || [] // 초기값을 빈 배열로 설정
        ...
        {randomNumArr.map((randomNum, i) => {
          ...
          return (
            <S.Perk key={i}>
              ...
              <S.Info>
                <S.PerkTitle>
                  {filteredPerks[randomNum]?.name} {/* 안전한 접근 */}
